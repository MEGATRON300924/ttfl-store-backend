...
trackingRouter.post("/public",asyncHandler(async(req,res)=>{const input=publicSchema.parse(req.body);res.json(await service.trackPublic(input.orderNumber,input.productId));}));
